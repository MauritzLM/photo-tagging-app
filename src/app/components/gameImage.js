...
export default function GameImage({ gameImage, setCoords, setImageWidth, setImageHeight, imageWidth }) {
    ...
    return (
        <>
            <picture data-testid="picture" className="w-full h-full cursor-pointer" onClick={(e) => setCoords(e)}>
                <Image ref={ref} src={gameImage.src} priority={true} as="image" alt="" height={800} width={800} className="w-full h-full" />
            </picture>
        </>
    )
}
